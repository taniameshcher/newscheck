...
for article in data["articles"]:
    ...
    timestamp = from_utc(publishedAt) #dateutil.parser.parse(article["publishedAt"])
    timeToPrint = '{}-{}-{} {}:{}'.format(timestamp.day, timestamp.month, timestamp.year, timestamp.hour, timestamp.minute)
    print ("------------------------")
